            ...
            <Link href={"/events/" + event.id}>
                <div className="w-full block h-full">
                    <div className="h-60 overflow-hidden">
                        <Image alt="Event image" src={event.imageurl} className="object-cover w-full h-full" height={650} width={700} placeholder="blur" blurDataURL={`data:image/svg+xml;base64,${toBase64(shimmer(650, 700))}`} />
                    </div>
